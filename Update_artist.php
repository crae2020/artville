<?php
  ...
  $sql = "SELECT * FROM artists where artist_id = '$_SESSION[user_id]'";
  $to_update = mysqli_query($conn, $sql);
  $row = mysqli_fetch_assoc($to_update);

  if(isset($_POST['editInfo'])){
    $name = $_POST['fullname']? $_POST['fullname']: $row['fullname'];  
    $email = $_POST['email'] ? $_POST['email'] : $row['email'];
    $style = $_POST['style']? $_POST['style'] : $row['art_style'];
    $title = $_POST['title'] ? $_POST['title'] : $row['art_title'];
    $year = $_POST['year']?$_POST['year']: $row['year_created'];
        ...
        <div class="u-form u-form-1">
          <form method="POST" name="form" style="padding: 10px;">
            ...
            <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Enter your Name" id="name-456f" name="fullname" class="u-border-2 u-border-grey-30 u-input u-input-rectangle u-radius-5 u-white" >
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-456f" class="u-label">Email address</label>
              <input type="email" placeholder="Enter a valid email address" id="email-456f" name="email" class="u-border-2 u-border-grey-30 u-input u-input-rectangle u-radius-5 u-white" >
            </div>
            <div class="u-form-group u-form-group-3">
              <label for="text-36d9" class="u-label">Art style</label>
              <input type="text" placeholder="Enter your style of art " id="text-36d9" name="style" class="u-border-2 u-border-grey-30 u-input u-input-rectangle u-radius-5 u-white" >
            </div>
            <div class="u-form-group u-form-group-4">
              <label for="text-da76" class="u-label">Art title</label>
              <input type="text" placeholder="Enter the title of your artwork" id="text-da76" name="title" class="u-border-2 u-border-grey-30 u-input u-input-rectangle u-radius-5 u-white" >
            </div>
